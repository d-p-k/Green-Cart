...
export const ProductCard = ({ product }) => {
  ...
  return (
    product && (
      <div className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-40 w-full">
        <div
          className="group cursor-pointer flex items-center justify-center px-2 h-40 w-full"
          onClick={() =>
            navigate(
        ...
        >
          <img
            className="group-hover:scale-105 transition size-40 object-contain"
